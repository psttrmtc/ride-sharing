...
type Driver struct {
	...
	ProfilPicture string                 `protobuf:"bytes,3,opt,name=profilPicture,proto3" json:"profilPicture,omitempty"`
...
func (x *Driver) GetProfilPicture() string {
	if x != nil {
		return x.ProfilPicture
	}
	return ""
}
...
const file_driver_proto_rawDesc = "" +
	...
	"\rprofilPicture\x18\x03 \x01(\tR\rprofilPicture\x12\x1a\n" +
